...
import type { GenerateImageResult as _GenerateImageResult, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async generateImage(arg0: GenerateImageArgs, arg1: string, arg2: string): Promise<GenerateImageResult> {
        if (this.processError) {
            try {
                const result = await this.actor.generateImage(arg0, arg1, arg2);
                return from_candid_GenerateImageResult_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async legacyGenerateImage(arg0: GenerateImageArgs): Promise<GenerateImageResult> {
        if (this.processError) {
            try {
                const result = await this.actor.legacyGenerateImage(arg0);
                return from_candid_GenerateImageResult_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_GenerateImageResult_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _GenerateImageResult): GenerateImageResult {
